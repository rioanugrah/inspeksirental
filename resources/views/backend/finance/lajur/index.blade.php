...
@section('title')
    Finance - Neraca Lajur
@endsection
@section('css')
@endsection
@section('content')
    @include('backend.finance.lajur.modalLaporanBulanan')
    @include('backend.finance.lajur.modalLaporanTahunan')
    <div class="row">
        <div class="col-md-12">
            <div class="page-title-box">
                <h4 class="page-title">Neraca Lajur</h4>
            </div>
            <div class="card">
                <div class="card-body">
