                    ...
                    <div class="col-lg-6 p-4 text-center">
                        ...
                        <svg version="1.1" xmlns:x="&ns_extend;" xmlns:i="&ns_ai;" xmlns:graph="&ns_graphs;"
                                ...
                                <style type="text/css">
                                    ...
                                    .st1{fill:#43d39e;}
                                    .st2{fill:#FFFFFF;stroke:#43d39e;stroke-width:2;stroke-miterlimit:10;}
                        ...
                        {{-- <h4 class="h4 mb-2 mt-2">Confirm your email</h4> --}}
                        {{-- <p class="text-muted mt-1 mb-2">Your account has been successfully registered. To complete the verification process, please check your email for a validation request.</p> --}}
                        @if (session('resent'))
                            <div class="alert alert-success" role="alert">
                                {{ __('A fresh verification link has been sent to your email address.') }}
                            </div>
                        @endif
                        <h4 class="h4 mb-2 mt-2">{{ __('Verify Your Email Address') }}</h4>
                        <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                            @csrf
                            <button type="submit" class="btn btn-link p-0 m-0 align-baseline">{{ __('Resend Verify') }}</button>.
                        </form>
                    </div>
