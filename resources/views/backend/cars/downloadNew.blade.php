...
<body>
    ...
    <div id="printableArea">
        ...
        <div style="font-weight: bold; text-align: center; margin-bottom: 2.5%">Laporan Hasil Inspeksi Kendaraan</div>
        <table>
            <tr>
                <td>No. References</td>
                <td>:</td>
                <td>{{ $car->no_reference }}</td>
            </tr>
            <tr>
                <td>Tanggal Dibuat</td>
                <td>:</td>
                <td>{{ $car->created_at->isoFormat('DD MMMM YYYY') }}</td>
            </tr>
            <tr>
                <td>No. Polisi</td>
                <td>:</td>
        ...
        {{-- <table style="background-color: #FFD35A">
            <tr>
                <td>
                    <div style="padding: 2.5%; font-weight: bold">Laporan Kondisi Kendaraan No. {{ $car->no_reference }}
                    </div>
                </td>
                <td style="text-align: right">
                    <div style="padding: 2.5%; font-weight: bold">Tanggal Buat :
                        {{ $car->created_at->isoFormat('DD MMMM YYYY') }}</div>
                </td>
            </tr>
        </table>
        ...
        <table style="width: 100%; margin: 1.5%">
            @if (!empty($car->detail_inspeksi_depan))
                <tr>
                    <td colspan="4">
                        <div style="margin-top: 2.5%; margin-bottom: 2.5%; font-weight: bold"><span
                                class="dot"></span> Bagian Depan</div>
                    </td>
                </tr>
                <tr>
            ...
            @if (!empty($car->detail_inspeksi_kiri))
                <tr>
                    <td colspan="4">
                        <div style="margin-top: 2.5%; margin-bottom: 2.5%; font-weight: bold"><span
                                class="dot"></span> Bagian Kiri</div>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: middle">
            ...
            @if (!empty($car->detail_inspeksi_kanan))
                <tr>
                    <td colspan="4">
                        <div style="margin-top: 2.5%; margin-bottom: 2.5%; font-weight: bold"><span
                                class="dot"></span> Bagian Kanan</div>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: middle">
            ...
            @if (!empty($car->detail_inspeksi_belakang))
                <tr>
                    <td colspan="4">
                        <div style="margin-top: 2.5%; margin-bottom: 2.5%; font-weight: bold"><span
                                class="dot"></span> Bagian Belakang</div>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: middle">
        ...
        <table style="width: 100%">
            <tr>
                <td>
                    ...
                    <img src="{{ asset('backend/mobil/' . $car->plat_nomor . '/berkas/' . $car->foto_kendaraan) }}"
                        style="width: 220px; height: 250px; object-fit: cover;">
                </td>
                <td>
                    <div>Foto STNK</div>
                    <img src="{{ asset('backend/mobil/' . $car->plat_nomor . '/berkas/' . $car->foto_stnk) }}"
                        style="width: 220px; height: 250px; object-fit: cover;">
                </td>
                <td>
                    <div>Foto Sisi Depan</div>
                    <img src="{{ asset('backend/mobil/' . $car->plat_nomor . '/berkas/' . $car->foto_sisi_depan) }}"
                        style="width: 220px; height: 250px; object-fit: cover;">
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <img src="{{ asset('backend/mobil/' . $car->plat_nomor . '/berkas/' . $car->foto_sisi_belakang) }}"
                        style="width: 220px; height: 250px; object-fit: cover;">
                </td>
                <td>
                    <div>Foto Sisi Kiri</div>
                    <img src="{{ asset('backend/mobil/' . $car->plat_nomor . '/berkas/' . $car->foto_sisi_kiri) }}"
                        style="width: 220px; height: 250px; object-fit: cover;">
                </td>
                <td>
                    <div>Foto Sisi Kanan</div>
                    <img src="{{ asset('backend/mobil/' . $car->plat_nomor . '/berkas/' . $car->foto_sisi_kanan) }}"
                        style="width: 220px; height: 250px; object-fit: cover;">
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <img src="{{ asset('backend/mobil/' . $car->plat_nomor . '/berkas/' . $car->foto_sisi_interior) }}"
                        style="width: 220px; height: 250px; object-fit: cover;">
                </td>
            </tr>
        </table>
        ...
        <div class="grid-coverer">
            ...
            {{-- @else
                <div class="grid-item">
                    <div>Pintu Bagasi Belakang</div>
                    <div>{{ $car->detail_inspeksi_belakang->pintu_bagasi_belakang }}</div>
                </div> --}}
            @endif
            @if ($car->detail_inspeksi_belakang->bumper_belakang == 'Rusak')
                <div class="grid-item">
            ...
            {{-- @else
                <div class="grid-item">
                    <div>Bumper Belakang</div>
                    <div>{{ $car->detail_inspeksi_belakang->bumper_belakang }}</div>
                </div> --}}
            @endif
        </div>
        ...
        <div class="grid-coverer">
            @foreach (json_decode($car->detail_inspeksi_lain->body) as $key => $body)
                <div class="grid-item">
                    ...
                    <img src="{{ asset('backend/mobil/' . $car->plat_nomor . '/berkas/pengecekkan_bagian_lain/' . $body->foto_lain_lain) }}"
                        style="width: 250px; height: 250px; object-fit: cover;">
